...
function initTowhub() {
    ...
    if ($(".similar-cheaters").length > 0) {
        var j2 = new Swiper(".similar-cheaters .swiper-container", {
            preloadImages:true,
            slidesPerView: 4,
            spaceBetween: 20,
            loop: true,
 ...
 // date picker------------------
    ...
    $('.dateRP').on('apply.daterangepicker', function (ev, picker) {
        $(this).val(picker.startDate.format('YYYY-MM-DD') + ' - ' + picker.endDate.format('YYYY-MM-DD'));
    });
    $('.dateRP').on('cancel.daterangepicker', function (ev, picker) {
        $(this).val('');
    });
    //   appear------------------
...
// bubbles -----------------
    ...
    // sorting
    $(document).on('change','#sortingTrigger',function(){
    ...
    $(".looking_for").easyAutocomplete(options);
    ...
    var options = {
        ...
        preparePostData: function(data) {
            data.phrase = $("#home_keywords_search").val();
            return data;
        },
    ...
    $("#home_keywords_search").easyAutocomplete(options);
    ...
    var options = {
        ...
        preparePostData: function(data) {
            data.phrase = $("#cheater_keywords_search").val();
            return data;
        },
    ...
    $("#cheater_keywords_search").easyAutocomplete(options);
}
//   Parallax ------------------
