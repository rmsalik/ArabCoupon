                                ...
                                <div class="col-xl-8 offset-xl-2">
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="insurance_fees" required="" placeholder="Enter Insurance Fees" class="form-control m-input" value="{{$data->insurance_fees}}">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="fuel_fees" required="" placeholder="Enter Fuel Fees" class="form-control m-input" value="{{$data->fuel_fees}}">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="pickup_fees" required="" placeholder="Enter Pickup Fees" class="form-control m-input" value="{{$data->pickup_fees}}">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="dropoff_fees" required="" placeholder="Enter Dropoff Fees" class="form-control m-input" value="{{$data->dropoff_fees}}">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="pickupanddropoff_fees" required="" placeholder="Enter Pickup & Dropoff Fees" class="form-control m-input" value="{{$data->pickupanddropoff_fees}}">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="engine" required="" placeholder="Enter Engine" class="form-control m-input" value="{{$data->engine}}">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="interior" required="" placeholder="Enter Interior" class="form-control m-input" value="{{$data->interior}}">
                                        ...
                                        <img src="{{$img->name}}" width="150px" height="120px" style="margin:2px;"> 
                                        @endforeach
                                    </div>
                                    <div class="form-group m-form__group row">
