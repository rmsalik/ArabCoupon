            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="javascript:;" class="m-nav__link">
                        <span class="m-nav__link-text">Add New Office</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__body">
                    <form class="m-form m-form--label-align-left- m-form--state-" method="post" action="{{route('office-crud.store')}}" id="m_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <!--begin: Form Body -->
                        <div class="m-portlet__body">
                            <div class="row">
                                    ...
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <input type="text" name="name" required="" placeholder="Office Name" class="form-control m-input" value="{{old('name')}}">
