        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-wrapper">
                        ...
                        <div class="m-portlet__head-tools">
                            <a href="{{route('top-coupon-crud.index')}}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                                <span>
                ...
                <div class="m-portlet__body">
                    <form class="m-form m-form--label-align-left- m-form--state-" method="post" action="{{route('top-coupon-crud.store')}}" id="m_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <!--begin: Form Body -->
                        <div class="m-portlet__body">
                            <div class="row">
                                <div class="col-xl-8 offset-xl-2">
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea name="description" class="form-control m-input" required="" placeholder="Maximum 500 characters" maxlength="500">{{old('description')}}</textarea>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea name="arabic_description" class="form-control m-input" required="" placeholder="Maximum 500 characters" maxlength="500">{{old('arabic_description')}}</textarea>
                                                <span class="m-form__help">Please enter description</span>
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea name="detail" class="form-control m-input" required="" placeholder="Maximum 500 characters" maxlength="500">{{old('detail')}}</textarea>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea name="arabic_detail" class="form-control m-input" required="" placeholder="Maximum 500 characters" maxlength="500">{{old('arabic_detail')}}</textarea>
                                                <span class="m-form__help">Please enter detail</span>
                                            </div>
                                        </div>
                                        <!--<div class="form-group m-form__group row">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <select class="bootstrap-select" required="" name="country_id">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">* Is Top Coupon:</label>
                                            <div class="col-xl-9 col-lg-9">
                                                <select class="bootstrap-select" name="is_top" required="">
                                                            <option value="1" name="is_top" selected="1">Yes</option>
                                                            <option value="0" name="is_top" >No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
