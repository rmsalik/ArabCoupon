        ...
        <div class="col-lg-12">
            ...
            <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                ...
                <div class="m-portlet__body">
                    <form class="m-form m-form--label-align-left- m-form--state-" method="post" action="{{route('top-coupon-crud.update',$data->id)}}" id="m_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <!--begin: Form Body -->
                        <div class="m-portlet__body">
                                ...
                                <div class="col-xl-8 offset-xl-2">
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea name="detail" class="form-control m-input"  placeholder="Maximum 500 characters" maxlength="500">{{$data->detail}}</textarea>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <textarea name="arabic_detail" class="form-control m-input"  placeholder="Maximum 500 characters" maxlength="500">{{$data->arabic_detail}}</textarea>
                                                <span class="m-form__help">Please enter detail</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-xl-9 col-lg-9">
                                                <select class="bootstrap-select" name="is_top">
                                                            <option value="1" name="is_top" @if($data->is_top == 1) selected @endif>Yes</option>
                                                            <option value="0" name="is_top" @if($data->is_top == 0) selected @endif>No</option>
                                                </select>
                                            </div>
                                        </div>
                                    <!--<div class="form-group m-form__group row">
